        ...
        <div class="container">
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
				    <a href="http://www.viasolrecife.com.br/loja/" target="_blank"><img class="img-responsive img-center img-rounded" src="../images/banner_loja_viasol_site_novo_v3.png" alt=""></a>
				</div>      	
			</div>      
