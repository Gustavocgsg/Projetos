        ...
        <div class="container">
			...
			<?php
				...
				try{
					//$consulta = $pdo->prepare("SELECT * FROM noticia WHERE caderno='Novidades' ORDER BY id DESC LIMIT 1");
					$consulta = $pdo->prepare("SELECT * FROM noticia WHERE caderno='Novidades' AND id='20'");
			...
			?>  
 			<div class="row">
				<div class="col-sm-12 col-md-12">
					<a href="http://www.viasolrecife.com.br/loja/" target="_blank"><img class="img-responsive img-center img-rounded" src="../images/banner_loja_superfardas_site.png" alt=""></a>
				</div>      	
			</div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <img class="img-responsive img-center img-rounded" src="../images/img_linha_fire.png" alt="">
                    <h2 class="text-center">Linha Fire</h2>
                ...
                <div class="col-sm-4">
                    <img class="img-responsive img-center img-rounded" src="../images/img_lista_produtos.png" alt="">
                ...
                <div class="col-sm-4">
                    <img class="img-responsive img-center img-rounded" src="../images/img_solicitar_orcamento.png" alt="">
			...
			<?php
				...
				try{
					$consulta = $pdo->prepare("SELECT * FROM noticia WHERE caderno='Novidades' AND id='33'");
					$consulta->bindParam(':caderno', $_GET['caderno'], PDO::PARAM_STR);
					$consulta->execute();
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
				    <a href="http://www.viasolrecife.com.br/loja/" target="_blank"><img class="img-responsive img-center img-rounded" src="../images/banner_loja_viasol_site.png" alt=""></a>
				</div>      	
			</div>      
