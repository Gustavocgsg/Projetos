        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                  <h3>Orçamento</h3>
                  <form method="POST" action="?paginas=email_orca" name="formContato" name="sentMessage" id="contactForm" novalidate>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div class="tab-pane fade active in" id="service-one">
										...
										<a class="btn btn-default" class="fancybox" id="fancybox-effects-a" href="../images/img_ilustracao.png" title="">
										 <!--<img class="" class="fancybox" src="" alt="Vizualizar modelos">-->
											<i class="fancybox" href="">Ver detalhes</i>
										</a>
                                        <br><br>
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="balaclava" value="balaclava" name="produto">Balaclava
                                        </label>										
                                    </div>
                                    <div class="tab-pane fade" id="service-two">
                                        <h4>Tecido</h4>
                                        <!--<label class="checkbox-inline">
                                            <input type="checkbox" id="brim_uniforte" value="brim_uniforte" name="produto">Brim Uniforte
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="unioffice_camisaria" value="unioffice_camisaria" name="produto">Unioffice camisaria
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="uniforte" value="uniforte" name="produto">Uniforte
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="unisafe" value="unisafe" name="produto">Unisafe
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="malha_fio_de_escocia" value="malha_fio_de_escocia" name="produto">Malha fio de escocia
                                        </label>-->
                                    ...
                                    <div class="tab-pane fade" id="service-three">
                                        ...
                                        <hr>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="azul_royal" value="azul_royal" name="produto">Azul royal
                                        </label>
                                        <label class="checkbox-inline">
